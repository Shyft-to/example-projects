            ...
            <div className="row">
              <div className="col-md-12 col-lg-4">
                ...
                >
                  ...
                  <div className="card-body">
                    <h4 className="card-title text-light cfont">Green Tier (3 months)</h4>
              ...
              <div className="col-md-12 col-lg-4">
                ...
                >
                  ...
                  />
                  <div className="card-body">
                    <h4 className="card-title text-light cfont">Blue Tier (6 months)</h4>
                    <p className="card-text text-light cfont">
                        30% discount - 1 SOL
                    </p>
                    <button
              ...
              <div className="col-md-12 col-lg-4">
                ...
                >
                  ...
                  />
                  <div className="card-body">
                    <h4 className="card-title text-light cfont">Red Tier (9 months)</h4>
                    <p className="card-text text-light cfont">
                      40% discount - 1.2 SOL
                    </p>
                    <button
