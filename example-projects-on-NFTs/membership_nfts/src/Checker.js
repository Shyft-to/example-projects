                ...
                <div className="container-xl">
                    <div className="row">
                        <div className="col-md-12 col-lg-7 p-5">
                            ...
                            <h4 className="sub-heading mb-5">Just another fantasy marketplace for your 8-bit needs.</h4>
                            <button className="btn btn-dark px-4 rounded-pill bit-btn" onClick={solanaConnect}>Connect Wallet</button>
                        </div>
